...
// AdminEditEmployee provides a mock function with given fields:
func (_m *UserHandler) AdminEditEmployee() echo.HandlerFunc {
	ret := _m.Called()
...
// Csv provides a mock function with given fields:
func (_m *UserHandler) Csv() echo.HandlerFunc {
	ret := _m.Called()
...
func (_m *UserHandler) GetAllEmployee() echo.HandlerFunc {
	ret := _m.Called()
...
// ProfileEmployee provides a mock function with given fields:
func (_m *UserHandler) ProfileEmployee() echo.HandlerFunc {
	ret := _m.Called()
